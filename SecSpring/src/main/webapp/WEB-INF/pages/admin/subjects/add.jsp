...
<section id="main" class="column">
    <script>
        if(${addStatus}==1) alert("Предмет добавлен")
    </script>


    <form name="new_subject" action="add" method="POST">
        <article class="module width_full">
            <header><h3>Добавить новый предмет</h3></header>
            <div class="module_content">
                <fieldset style="width:48%; float:left; margin-right: 3%;">
                    <label>Название</label>
                    <input type="text" style="width:92%;" name="j_subject" value="${j_subject}">
                </fieldset>
