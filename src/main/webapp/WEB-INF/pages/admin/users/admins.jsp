            ...
            <ul class="pagination">
                ...
                <c:forEach var="i" begin="${begin}" end="${end}">
                    <c:if test="${i <= curPage+2}">
                        <c:if test="${curPage == i}">
                            <li class="active"><a href="/admin/users/admins?page=${i}"><c:out
                                    value="${i+1}"/>
                ...
                <c:if test="${curPage == totalPages}">
                    <li class="disabled"><a href="/admin/users/admins?page=${totalPages-1}">&raquo;</a>
                    </li>
                </c:if>
                <c:if test="${curPage < totalPages}">
                    <li><a href="/admin/users/admins?page=${totalPages-1}">&raquo;</a></li>
                </c:if>
            </ul>
            <!--end Pages -->
