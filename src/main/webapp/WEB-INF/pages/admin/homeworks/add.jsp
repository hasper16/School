...
<section id="main" class="column">
    ...
    <%-- Notifications--%>
        ...
        <form class="form-horizontal" role="form" method="post" action="/admin/homeworks/add">
            <article class="module width_full">
                <header><h3>Новое задание</h3></header>
                            ...
                            <fieldset style="width:100%; float:left;">
                                <div class="col-md-11">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control input-sm" rows="12" minlength="10" id ="inputDescription" name="j_description"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
