...
<section id="main" class="column">
    ...
    <form class="form-horizontal" role="form" method="post" action="/admin/times/add">
        <article class="module width_full">
            <header><h3>Добавить новый урок</h3></header>
                    ...
                    <fieldset style="width:48%; float:left; margin-right: 3%">
                        <div class="col-md-11">
                            <div class="form-group">
                                ...
                                <input class="form-control input-sm" id="inputLessonNum" type="number" max="99" min="0" name="j_lessonNum"
                                       value="${j_lessonNum}"/>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <fieldset style="width:48%; float:left; margin-right: 3%">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-sm" id="inputDuration" type="number" min="0" name="j_duration"
                                           value="${j_duration}"/>
                                </div>
                            </div>
                        </fieldset>
